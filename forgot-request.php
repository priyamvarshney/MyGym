...
if (isset($_POST['send_request'])) {
	...
	$url = "http://localhost/gymlife/create-new-request.php?selector=" . $selector . "&validator=" . $token;
    ...
    $mail->Body    = '<div style="color: black;">Click on the link given below to reset your password.<br><br><br><a href="'.$url.'">'.$url.'</a><div>';
