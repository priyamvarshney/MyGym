...
<head>
    ...
    <title>Vandor -> Dashboard | DGM</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="leave-comment">
                        ...
                        <form action="forgot-request.php" method="post">
                            <input type="text" name="email" placeholder="Email" required>
                            <button type="submit" name="send_request">Reset Now</button>
                        </form><br>
                        <?php

                        if (isset($_GET['reset'])) {
                            if ($_GET['reset'] == 'success') {
                            echo "<p class='text-primary'>Reset link has been successfully sent to your email id!</p>";
                            }
                        }
