        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="input-group mb-3">
                    <form action="search_service.php?search=<?= md5(uniqid())?>/Search" method="post" class="input-group mb-3">
                ...
                <p style="color: green; text-transform: capitalize;"><b>Your Search Location : <u><?= $search_city ?></u></b></p>
            </div>
        </div>
